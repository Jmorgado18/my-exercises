...
public class GameWindow implements MouseHandler {
    ...
    private void updateScoreBoard() {
        ...
        Picture picture = new Picture(1015, 375, "rsc/scoreboard.png");
        picture.draw();
    ...
    private void drawGrid() {
        ...
        background.draw();
        Picture title = new Picture(975,100, "rsc/Title.png");
        title.draw();
        gridPicture = new Picture(PADDING, PADDING, "rsc/tic-tac-toe.png");
