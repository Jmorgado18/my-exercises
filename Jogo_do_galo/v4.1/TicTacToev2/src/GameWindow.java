...
public class GameWindow implements MouseHandler {
    ...
    public GameWindow() {
        ...
        playBackgroundMusic("rsc/Backgroundmusic.wav"); // Start background music
        loadClickSound("rsc/Click.wav"); // Load click sound
    }
    ...
    private void updateScoreBoard() {
        ...
        Picture picture = new Picture(1080, 420, "rsc/scoreboard.png");
        picture.draw();
    ...
    private void drawGrid() {
        ...
        Picture background = new Picture(PADDING,PADDING, "rsc/Background.jpg");
        background.draw();
        Picture titlex = new Picture(1100,50, "rsc/x.png");
        Picture titleo = new Picture(1360,50, "rsc/o.png");
        Picture title = new Picture(1160,0, "rsc/Title.png");
        titlex.draw();
        titleo.draw();
        title.draw();
        gridPicture = new Picture(50 + PADDING, 20 + PADDING, "rsc/Grid.png");
    ...
    private void drawX(int row, int col) {
        ...
        Picture picture = new Picture(x + PADDING, y + PADDING, "rsc/x.png");
        picture.draw();
    ...
    private void drawO(int row, int col) {
        ...
        Picture picture = new Picture(x + PADDING, y + PADDING, "rsc/o.png");
        picture.draw();
        pictureList.add(picture); // Track the picture for later deletion
    }
    ...
    private void displayMessage(String messageType) {
        ...
        switch (messageType) {
            case "Player 1 wins!":
                messagePicture = new Picture(centerX - 485, centerY - 200, "rsc/Player1.png"); // Adjust coordinates and image path
                playMusic("rsc/Player1wins.wav");
                break;
            case "Player 2 wins!":
                messagePicture = new Picture(centerX - 485, centerY - 200, "rsc/Player2.png"); // Adjust coordinates and image path
                playMusic("rsc/Player2wins.wav");
                break;
            case "Draw!":
                messagePicture = new Picture(centerX - 500, centerY - 280, "rsc/Draw.png"); // Adjust coordinates and image path
                playMusic("rsc/Draw.wav");
                break;
        }
