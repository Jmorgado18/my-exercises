...
<head>
    ...
    <title>Levantamento - JavaBank</title>
...
<body>
<header>
    <h1>JavaBank - Levantamento</h1>
</header>
<div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="card p-4" style="width: 350px;">
        <h4 class="text-center mb-4">Selecione a Conta e o Valor para Levantar</h4>
        <form action="menu.html">
            ...
            <div class="mb-3">
                <label for="amount" class="form-label">Quantia para Levantar</label>
                <input type="number" id="amount" class="form-control" placeholder="Digite o valor" required>
            </div>
            <button type="submit" class="btn w-100">Validar Levantamento</button>
        </form>
